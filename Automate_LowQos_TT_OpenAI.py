...
Description:
This script fetches the call history data from Telecomsxchange's or NeuTrafix buyer's API and identifies failed calls 
...
# Set your OpenAI key
openai.api_key = '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'
...
username = 'tcxc_route_tester'
password = 'GezZkEwSFsYE'
